...
import org.apache.kafka.common.record.internal.{MemoryRecords, Records, SimpleRecord}
...
class DisklessLeaderEndPointTest {
   ...
   * forceComplete() runs onComplete() directly (bypassing tryComplete/probeDisklessFetch), which
